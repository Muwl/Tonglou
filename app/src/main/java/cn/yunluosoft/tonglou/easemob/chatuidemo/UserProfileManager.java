...
import cn.yunluosoft.tonglou.easemob.applib.controller.HXSDKHelper.HXSyncListener;
import cn.yunluosoft.tonglou.easemob.applib.utils.HXPreferenceUtils;
import cn.yunluosoft.tonglou.easemob.chatuidemo.domain.User;
import cn.yunluosoft.tonglou.easemob.chatuidemo.parse.ParseManager;
...
public class UserProfileManager {
	...
	public void asyncFetchContactInfosFromServer(List<String> usernames,
			final EMValueCallBack<List<User>> callback) {
	...
	public void asyncGetUserInfo(final String username,
			final EMValueCallBack<User> callback) {
