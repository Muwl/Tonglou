 ...
 */
package cn.yunluosoft.tonglou.easemob.chatuidemo;
...
import cn.yunluosoft.tonglou.easemob.applib.model.HXNotifier;
import cn.yunluosoft.tonglou.easemob.applib.model.HXNotifier.HXNotificationInfoProvider;
import cn.yunluosoft.tonglou.easemob.applib.model.HXSDKModel;
import cn.yunluosoft.tonglou.easemob.chatuidemo.domain.RobotUser;
		...
		eventListener = new EMEventListener() {
			...
			public void onEvent(EMNotifierEvent event) {
				...
				case EventNewMessage:
					if (ToosUtils.filterSysMes(appContext, message)) {
						return;
					}
