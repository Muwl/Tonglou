...
public class HelpAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        if (convertView==null){
            ...
            holder.content= (TextView) convertView.findViewById(R.id.help_item_tip);
            holder.time= (TextView) convertView.findViewById(R.id.help_item_time);
            holder.bluebtn= (TextView) convertView.findViewById(R.id.help_item_bluebtn);
            holder.graybtn= (TextView) convertView.findViewById(R.id.help_item_graybtn);
            holder.atten= (TextView) convertView.findViewById(R.id.help_item_atten);
