...
import cn.yunluosoft.tonglou.adapter.BitmapCache.ImageCallback;
...
//		cache = new BitmapCache();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			holder.shade = (ImageView) convertView
					.findViewById(R.id.item_shade);
		...
		bitmapUtils.display(holder.iv, item.imagePath);
...
//				callback);
		...
		holder.shade.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View v) {
				List<String> strings = new ArrayList<String>();
				for (int i = 0; i < dataList.size(); i++) {
					strings.add(dataList.get(i).imagePath);
				}

				Intent intent = new Intent(act, PhotoShowActivity.class);
