 ...
 * @Description 
 */
public class TradeSelectDialog implements OnClickListener {
	...
	public TradeSelectDialog(Context context, Handler handler, String temp) {
		super();
		this.context = context;
		this.handler = handler;
		this.temp = temp;
		d = new Dialog(context);
		List<String> list = Arrays.asList(Constant.TRADS);
