...
import cn.yunluosoft.tonglou.adapter.HelpDetailAdapter;
...
//                    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        umShareListener=new UMShareListener() {
            ...
            public void onResult(SHARE_MEDIA platform) {
                //Toast.makeText(HelpDetailActivity.this, platform + " 分享成功", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onError(SHARE_MEDIA platform, Throwable t) {
                Toast.makeText(HelpDetailActivity.this,platform + " 分享失败", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onCancel(SHARE_MEDIA platform) {
                Toast.makeText(HelpDetailActivity.this,platform + " 分享取消", Toast.LENGTH_SHORT).show();
            }
        };
    }
    ...
    private void initView() {
        ...
        customListView= (CustomListView) findViewById(R.id.helpdetail_list);
        sendEdit= (EditText) findViewById(R.id.helpdetail_edit);
        ...
        utils.send(HttpRequest.HttpMethod.POST, Constant.ROOT_PATH + "/v1_1_0/dynamic/dynamicDetail", rp,
                new RequestCallBack<String>() {
                    ...
                    public void onFailure(HttpException arg0, String arg1) {
                        ...
                        ToastUtils.displayFailureToast(HelpDetailActivity.this);
                    }
                        ...
                        try {
                            ...
                            if (Constant.RETURN_OK.equals(state.msg)) {
                                ...
                                ToastUtils.displayShortToast(
                                        HelpDetailActivity.this,
                                        (String) state.result);
                            }
                        } catch (Exception e) {
                            e.printStackTrace();
                            ToastUtils
                                    .displaySendFailureToast(HelpDetailActivity.this);
                        }
...
//                            }
                        ...
                        if (Constant.TOKEN_ERR.equals(state.msg)) {
                            ToastUtils.displayShortToast(HelpDetailActivity.this,
                                    "验证错误，请重新登录");
                            ToosUtils.goReLogin(HelpDetailActivity.this);
                        } else {
                            ToastUtils.displayShortToast(HelpDetailActivity.this,
                                    (String) state.result);
...
//                    }
                    ...
                    customListView.onLoadMoreComplete();
                    customListView.setCanLoadMore(false);
                    ToastUtils.displaySendFailureToast(HelpDetailActivity.this);
//                    if (entities.size() == 0) {
//                        empty.setVisibility(View.VISIBLE);
//                        empty_image.setImageDrawable(getResources()
//                                .getDrawable(R.drawable.empty_floor));
                            ...
                            if (Constant.RETURN_OK.equals(state.msg)) {
                                ...
                                if ("0".equals(entity.isPraise)){
                                    ...
                                    for (int i=0;i<entity.praiseUser.size();i++){
                                        if (entity.praiseUser.get(i).id.equals( ShareDataTool.getUserId(HelpDetailActivity.this))){
                                    ...
                                    entity.isPraise=0+"";
                                    User user=new User();
                                    user.id=ShareDataTool.getUserId(HelpDetailActivity.this);
                                    user.icon=ShareDataTool.getIcon(HelpDetailActivity.this);
                                    entity.praiseUser.add(0,user);
                                }
                                adapter.notifyDataSetChanged();
                            } else if (Constant.TOKEN_ERR.equals(state.msg)) {
                                ToastUtils.displayShortToast(
                                        HelpDetailActivity.this, "验证错误，请重新登录");
                                ToosUtils.goReLogin(HelpDetailActivity.this);
                            } else {
                                ToastUtils.displayShortToast(
                                        HelpDetailActivity.this,
                        ...
                        try {
                            ...
                            if (Constant.RETURN_OK.equals(state.msg)) {
                                ...
                                if (position==-1){
                                    ...
                                    replayEntity.publishUserIcon=ShareDataTool.getIcon(HelpDetailActivity.this);
                                    replayEntity.publishUserId=ShareDataTool.getUserId(HelpDetailActivity.this);
                                    replayEntity.publishUserNickname=ShareDataTool.getNickname(HelpDetailActivity.this);
